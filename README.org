    ...
    { // isDeviceSuitable
        {
            ...
            vkGetPhysicalDeviceQueueFamilyProperties(gpu, &queueFamilyCount, queueFamilies.data());  // findQueueFamilies
...
{// createLogicalDevice
    ...
    device_createInfo.ppEnabledExtensionNames = deviceExtensions.data();
